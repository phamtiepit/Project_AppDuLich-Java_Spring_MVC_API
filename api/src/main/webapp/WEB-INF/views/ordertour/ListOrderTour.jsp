...
<jsp:include page="/WEB-INF/views/header.jsp">
        <jsp:param name="title" value="Quản lí đặt tour" />
    </jsp:include>
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Quản lí đặt tour</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Quản lí đặt tour</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <c:set var="list" value="${requestScope.listOrderTour}" />
			        <c:forEach var="order" items="${list}">
			             <tr>
		                    ...
		                    <td>${order.status}</td>		                    
		                    <td class="text-right">
	                          <a class="btn btn-info btn-sm" href="edit/${order.id}">
	                              <i class="fas fa-pencil-alt"></i>
	                              Cập nhật
	                          </a>
	                          <!-- <a class="btn btn-danger btn-sm" href="delete/${order.id}">
