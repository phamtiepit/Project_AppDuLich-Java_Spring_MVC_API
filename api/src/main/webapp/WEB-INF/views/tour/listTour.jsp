          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <a class="btn btn-info float-right" href="add"><i class="fas fa-plus"></i> Thêm tour</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <c:set var="list" value="${requestScope.listTour}" />
			        <c:forEach var="tour" items="${list}">
			             <tr>
		                    ...
		                    <td>${tour.price}</td>		                   
		                    <td class="text-right">
	                          <a class="btn btn-info btn-sm" href="edit/${tour.id}">
	                              <i class="fas fa-pencil-alt"></i>
	                              Sửa
	                          </a>
	                          <a class="btn btn-danger btn-sm" href="delete/${tour.id}">
