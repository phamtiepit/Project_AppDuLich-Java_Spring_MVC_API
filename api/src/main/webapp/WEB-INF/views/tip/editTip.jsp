...
<jsp:include page="/WEB-INF/views/header.jsp">
        <jsp:param name="title" value="Cập nhật cẩm nang" />
    </jsp:include>
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Cập nhật cẩm nang</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Cập nhật cẩm nang</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-12">
			 <div class="card card-primary">
              <!-- form start -->
              <form:form modelAttribute="tipDTO" method="post" action="${pageContext.request.contextPath}/admin/tip/process-edit">
                <div class="card-body">
                  <input type="hidden" value="${tipDTO.id}" name="id">
                  <div class="form-group">
                    <label>Tiêu đề</label>
                    <input type="text" class="form-control" name="title" value="${tipDTO.title}">
                  </div>
                  <div class="form-group">
                    <label>Nội dung</label>
                    <textarea class="form-control" rows="3" name="content">${tipDTO.content}</textarea>
                  </div>
                </div>
                <!-- /.card-body -->
