...
<jsp:include page="/WEB-INF/views/header.jsp">
        <jsp:param name="title" value="Quản lí cẩm nang" />
    </jsp:include>
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Quản lí cẩm nang</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Quản lí cẩm nang</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Danh sách cẩm nang</h3>
                <a class="btn btn-info float-right" href="add"><i class="fas fa-plus"></i> Thêm cẩm nang</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <c:set var="list" value="${requestScope.listTip}" />
			        <c:forEach var="tip" items="${list}">
			             <tr>
		                    <td>${tip.id}</td>
		                    <td>${tip.title}</td>
		                    <td>${tip.content}</td>	                    	                    
		                    <td class="text-right">
	                          <a class="btn btn-info btn-sm" href="edit/${tip.id}">
	                              <i class="fas fa-pencil-alt"></i>
	                              Sửa
	                          </a>
	                          <a class="btn btn-danger btn-sm" href="delete/${tip.id}">
